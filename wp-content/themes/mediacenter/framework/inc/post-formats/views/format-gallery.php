<div id="cfpf-format-gallery-preview" class="cf-elm-block cf-elm-block-image" style="display: none;">
	<!-- <label><span><?php _e('Gallery Images', 'media_center'); ?></span></label> -->
	<div class="cf-elm-container">
		...
		<p class="none"><a href="#" class="button"><?php ($ids) ? _e('Edit Gallery', 'media_center') : _e('Add Images to Gallery', 'media_center'); ?></a></p>
