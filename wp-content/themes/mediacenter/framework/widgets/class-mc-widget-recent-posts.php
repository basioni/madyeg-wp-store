...
class MC_Widget_Recent_Posts extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Recent Posts with post thumbnails.', 'media_center' ) 
		);
		
		parent::__construct( 'mc-recent-posts', __( 'Media Center Recent Posts', 'media_center' ), $widget_ops );
...
?>
		<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'media_center' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" /></p>

		<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of posts to show:', 'media_center' ); ?></label>
