...
<div class="two-col-grid">
	...
	?>
		<div class="post-two-col-grid col-sm-6">
			<a href="<?php the_permalink(); ?>" class="text-center post-thumbnail" title="<?php echo sprintf( __( 'Post Format: %1$s', 'media_center' ), $post_format_text ); ?>">
				<?php 
			...
			<div class="read-more-div"><a class="le-button huge read-more" href="<?php echo get_permalink() ;?>"><?php echo __('Read More', 'media_center');?></a></div>
		</div>
		<?php if( ++$counter % 2 == 0 ) : ?>
