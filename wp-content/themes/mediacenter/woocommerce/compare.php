...
<div class="container">
    ...
    <div class="section section-page-title inner-xs">
        <div class="page-header">
            ...
            <p class="page-subtitle"><a id="product-comparison-page-clear-all" href="<?php echo $yith_woocompare->obj->remove_product_url('all') ?>" data-product_id="all" class="clear-all"><?php _e( 'Clear all', 'media_center' ) ?></a></p>
        </div>
    ...
    <div class="inner"> 
        ...
        <h1 class="lead-title text-center cart-empty">
            <?php _e( 'No products were added <br /> to the compare table', 'media_center' ) ?>
        </h1>
