...
global $product, $post, $media_center_theme_options;
...
<form class="cart" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="table group_table">
		<tbody>
			<?php
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button le-button huge button alt"><?php echo $product->single_add_to_cart_text(); ?></button>
