...
if ( is_active_sidebar( 'product-filters-widget-area' ) ) {
	...
	if ( ! empty( $product_filters_widgets ) ){
		...
		echo '<h3>' . __( 'Product Filters' , 'media_center' ) . '</h3>';
...
if ( is_active_sidebar( 'catalog-widget-area' ) ) {
	...
	the_widget( 'WC_Widget_Product_Categories', array( 'title' => __('Categories', 'media_center' ), 'orderby' => 'name', 'hierarchical' => 1 ), $catalog_widget_args );

	$catalog_widget_args['widget_id'] = 'special-offers';
	the_widget( 'WC_Widget_Products', array( 'title' => __( 'Special Offers', 'media_center' ), 'show' => 'onsale', 'number' => '5', 'orderby' => 'DESC', 'order' => 'date', 'id' => 'onsale-products' ), $catalog_widget_args );
	...
	the_widget( 'WC_Widget_Products', array( 'title' => __( 'Featured Products', 'media_center' ), 'show' => 'featured', 'number' => '5', 'orderby' => 'DESC', 'order' => 'date', 'id' => 'featured-products' ), $catalog_widget_args );
}